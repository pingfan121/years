...
namespace Easy4net.DBUtility
{
    ...
    {
        //获取数据库类型
        private static string strDbType = null;//CommonUtils.GetConfigValueByKey("dbType").ToUpper();

        //将数据库类型转换成枚举类型
        public static DatabaseType DbType = DatabaseType.MYSQL;//DatabaseTypeEnumParse<DatabaseType>(strDbType);

        public static string DbHost = null;//CommonUtils.GetConfigValueByKey("DbHost");
        public static string DbPort = null;//CommonUtils.GetConfigValueByKey("DbPort");
        public static string DbName = null;//CommonUtils.GetConfigValueByKey("DbName");
        public static string DbUser = null;//CommonUtils.GetConfigValueByKey("DbUser");
        public static string DbPassword = null;//CommonUtils.GetConfigValueByKey("DbPassword");
        public static string DbMinPoolSize = null;//CommonUtils.GetConfigValueByKey("DbMinPoolSize");
        public static string DbMaxPoolSize = null;//CommonUtils.GetConfigValueByKey("DbMaxPoolSize");
        public static string DbCharset = null;//CommonUtils.GetConfigValueByKey("DbCharset");
        ...
        public static void InitConfig()
        {
            ...
            DbType = DatabaseTypeEnumParse<DatabaseType>(strDbType);

            DbHost = CommonUtils.GetConfigValueByKey("DbHost");
            DbPort = CommonUtils.GetConfigValueByKey("DbPort");
            DbName = CommonUtils.GetConfigValueByKey("DbName");
            DbUser = CommonUtils.GetConfigValueByKey("DbUser");
            DbPassword = CommonUtils.GetConfigValueByKey("DbPassword");
            DbMinPoolSize = CommonUtils.GetConfigValueByKey("DbMinPoolSize");
            DbMaxPoolSize = CommonUtils.GetConfigValueByKey("DbMaxPoolSize");
            DbCharset = CommonUtils.GetConfigValueByKey("DbCharset");
        }

        public static void SetDbType(string sdt)
        {
            strDbType = sdt.ToUpper();
            DbType = DatabaseTypeEnumParse<DatabaseType>(strDbType);
        }

        public static void SetDbParmChar()
        {
